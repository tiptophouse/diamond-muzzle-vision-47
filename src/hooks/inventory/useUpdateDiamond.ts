    ...
    try {
      ...
      try {
        ...
        const updateData = {
          ...
          lab: data.lab,
          certificate_number: data.certificate_number ? Number(data.certificate_number) : null,
          length: data.length ? Number(data.length) : null,
          width: data.width ? Number(data.width) : null,
          depth: data.depth ? Number(data.depth) : null,
          ratio: data.ratio ? Number(data.ratio) : null,
          table: data.table ? Number(data.table) : null,
          depth_percentage: data.depth_percentage ? Number(data.depth_percentage) : null,
          gridle: data.gridle,
