...
export function AuthGuard({
  ...
  return <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
      <div className="text-center p-8 max-w-md mx-4 bg-white rounded-xl shadow-lg border">
        ...
        <div className="space-y-4 text-right">
          {error && <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        ...
        <div className="mt-6 space-y-3">
          ...
          {process.env.NODE_ENV === 'development' && <div className="text-xs text-gray-500 bg-gray-50 p-3 rounded text-right">
              מידע פיתוח:<br />
