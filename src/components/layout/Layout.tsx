...
export function Layout({
  ...
  return <div className="min-h-screen w-full overflow-x-hidden flex bg-background">
      ...
      <div className="flex-1 w-full min-w-0 flex flex-col bg-background lg:ml-0">
        ...
        <div className="lg:hidden flex items-center justify-between h-16 border-b border-border/20 bg-card/50 backdrop-blur-md px-0">
          ...
          <div className="flex items-center gap-3">
            <div className="w-7 h-7 rounded-xl bg-gradient-to-br from-[#0088cc] to-[#229ED9] flex items-center justify-center shadow-sm px-0">
