...
export function Layout({
  ...
  return <div className="min-h-screen w-full overflow-x-hidden flex bg-background">
      ...
      <div className="flex-1 w-full min-w-0 flex flex-col bg-background lg:ml-0">
        ...
        <div className="lg:hidden flex items-center justify-between h-14 sm:h-16 px-3 sm:px-4 border-b border-border/20 bg-card/50 backdrop-blur-md my-[35px] py-[49px]">
