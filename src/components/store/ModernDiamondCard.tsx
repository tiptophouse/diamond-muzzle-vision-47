  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square bg-gradient-to-br from-slate-50 to-slate-100 overflow-hidden">
        ...
        {/* Enhanced Overlay Actions with fixed button styling */}
        <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-all duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
          <div className="flex gap-3">
            <Button 
              size="sm" 
              variant="secondary" 
              className="bg-white/95 hover:bg-white border-0 shadow-xl backdrop-blur-sm min-w-[44px] min-h-[44px] p-2" 
              onClick={handleLike}
      ...
      <CardContent className="p-5 space-y-4">
        ...
        <div className="flex gap-3 pt-2">
          <Button 
            ...
            className="flex-1 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 min-h-[48px] font-semibold touch-target" 
            size="sm"
          >
          ...
          <Button 
            ...
            size="sm" 
            onClick={handleViewDetails} 
            className="px-4 bg-white hover:bg-slate-50 border-slate-300 hover:border-blue-400 min-h-[48px] font-semibold hover:text-blue-600 transition-all duration-300 touch-target"
          >
