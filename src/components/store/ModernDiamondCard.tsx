...
export function ModernDiamondCard({ diamond, index, onUpdate }: ModernDiamondCardProps) {
  ...
  return (
    <Card 
      ...
      className="group relative overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 border-0 shadow-lg bg-white"
      style={{ 
    ...
    >
      ...
      <div className="relative aspect-square bg-gradient-to-br from-slate-50 to-slate-100 overflow-hidden">
        {diamond.imageUrl && !imageError ? (
          ...
          /* Enhanced fallback with professional diamond imagery */
          <div className="flex items-center justify-center h-full bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="w-20 h-20 bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-600 rounded-full flex items-center justify-center shadow-2xl relative">
                <Star className="h-10 w-10 text-white" />
                {/* Sparkle effects */}
                <div className="absolute -top-2 -right-2 w-4 h-4 bg-gradient-to-br from-yellow-400 to-orange-400 rounded-full animate-pulse shadow-lg"></div>
                <div className="absolute -bottom-1 -left-1 w-3 h-3 bg-gradient-to-br from-pink-400 to-red-400 rounded-full animate-pulse delay-300 shadow-lg"></div>
              </div>
        ...
        <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-all duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
          <div className="flex gap-3">
            <Button 
              size="sm" 
              variant="secondary" 
              className="bg-white/95 hover:bg-white border-0 shadow-xl backdrop-blur-sm"
              onClick={handleLike}
            >
        ...
        <div className="absolute top-3 left-3">
          <Badge 
            className={`px-3 py-1.5 text-xs font-semibold border-0 shadow-lg backdrop-blur-sm ${
      ...
      <CardContent className="p-5 space-y-4">
        ...
        <div className="flex gap-3 pt-2">
          <Button 
            ...
            className="flex-1 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 h-12 font-semibold"
            size="sm"
          >
          ...
          <Button 
            ...
            size="sm"
            onClick={handleViewDetails}
            className="px-4 bg-white hover:bg-slate-50 border-slate-300 hover:border-blue-400 h-12 font-semibold hover:text-blue-600 transition-all duration-300"
          >
