      ...
      {SHAPES.map(({ name, icon: Icon, label }) => {
        ...
        return (
          <button
            ...
            className={`group relative flex flex-col items-center justify-center p-1.5 rounded-lg border-2 transition-all duration-300 min-h-[56px] hover:shadow-md hover:scale-105 touch-target ${
              isSelected
          ...
          >
            ...
            {isSelected && (
              <div className="absolute -top-1 -right-1 w-2.5 h-2.5 bg-blue-500 rounded-full shadow-lg">
