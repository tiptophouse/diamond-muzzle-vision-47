...
import { MessageCircle, ImageIcon, Gem, Share2 } from "lucide-react";
...
export function OptimizedDiamondCard({ diamond, index, onUpdate, onDelete }: OptimizedDiamondCardProps) {
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 flex items-center justify-center gap-2"
            >
            ...
            <button
              onClick={handleShare}
              className="bg-green-600 hover:bg-green-700 text-white px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300 flex items-center justify-center"
            >
