...
import { DiamondShareButton } from "./DiamondShareButton";
      ...
      <div className="p-4">
        ...
        <div className="flex gap-2">
          <Button 
            variant="outline" 
            size="sm" 
            className="flex-1 min-h-[40px] px-3 py-2 border-border text-foreground hover:bg-muted touch-target bg-background"
          ...
          <Button 
            variant="default" 
            size="sm" 
            className="flex-1 min-h-[40px] px-3 py-2 bg-primary text-primary-foreground hover:bg-primary/90 touch-target"
...
export default memo(OptimizedDiamondCard);
