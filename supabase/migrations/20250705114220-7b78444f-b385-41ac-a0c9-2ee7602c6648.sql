...
-- Fix update_updated_at_column function (already fixed but ensuring consistency)
...
-- Configure Auth settings to address OTP expiry warning
-- Set OTP expiry to recommended 1 hour (3600 seconds) instead of default longer period
UPDATE auth.config 
SET otp_exp = 3600 
WHERE TRUE;